...
function __set_kubefed_defaults {
    ...
    local DEFAULT_KUBEFED_KUBEFEDCTL_VERSION=0.1.0-rc6
    ...
    if [[ "${KUBEFED_KUBEFEDCTL_URL:-}" == "" ]]; then
        KUBEFED_KUBEFEDCTL_URL=${KUBEFED_KUBEFEDCTL_BASE_URL}/v${KUBEFED_KUBEFEDCTL_VERSION}/kubefedctl-${KUBEFED_KUBEFEDCTL_VERSION}-${OS}-amd64.tgz
    fi
